...
class CollageView4Image4(
    ...
    private fun resizeImage0(deltaWidth: Float, deltaHeight: Float) {
        val okToAdjustWidth =
            imageSizeAndPosCache[0].width + deltaWidth in minDimension..(layoutWidth - minDimension)
        val okToAdjustHeight =
            imageSizeAndPosCache[0].height + deltaHeight in minDimension..(layoutHeight - minDimension)
        ...
        imageSizeAndPosCache[3].height = layoutHeight - imageSizeAndPosCache[0].height
        imageSizeAndPosCache[3].y = imageSizeAndPosCache[0].height
    ...
    private fun resizeImage1(deltaWidth: Float, deltaHeight: Float) {
        val okToAdjustWidth =
            imageSizeAndPosCache[1].width - deltaWidth in minDimension..(layoutWidth - minDimension)
        val okToAdjustHeight =
            imageSizeAndPosCache[1].height + deltaHeight in minDimension..(layoutHeight - minDimension)
        ...
        imageSizeAndPosCache[3].height = layoutHeight - imageSizeAndPosCache[1].height
        imageSizeAndPosCache[3].y = imageSizeAndPosCache[1].height
    ...
    private fun resizeImage2(deltaWidth: Float, deltaHeight: Float) {
        val okToAdjustWidth =
            imageSizeAndPosCache[2].width + deltaWidth in minDimension..(layoutWidth - minDimension)
        val okToAdjustHeight =
            imageSizeAndPosCache[2].height - deltaHeight in minDimension..(layoutHeight - minDimension)
        ...
        imageSizeAndPosCache[1].height = layoutHeight - imageSizeAndPosCache[2].height

        imageSizeAndPosCache[3].width = layoutWidth - imageSizeAndPosCache[2].width
        imageSizeAndPosCache[3].height = imageSizeAndPosCache[2].height
        imageSizeAndPosCache[3].x = imageSizeAndPosCache[2].width
    ...
    private fun resizeImage3(deltaWidth: Float, deltaHeight: Float) {
        val okToAdjustWidth =
            imageSizeAndPosCache[3].width - deltaWidth in minDimension..(layoutWidth - minDimension)
        val okToAdjustHeight =
            imageSizeAndPosCache[3].height - deltaHeight in minDimension..(layoutHeight - minDimension)
        ...
        imageSizeAndPosCache[2].width = layoutWidth - imageSizeAndPosCache[3].width
